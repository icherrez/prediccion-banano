...
![Histograma de precios](https://github.com/icherrez/prediccion-banano/blob/main/images/histograma_precios.png)

2. **Boxplot de precios con outliers**  
![Boxplot de precios](https://github.com/icherrez/prediccion-banano/blob/main/images/boxplot_precios.png)

3. **Serie temporal con outliers detectados por Z-score e IQR**  
![Serie temporal con outliers](https://github.com/icherrez/prediccion-banano/blob/main/images/serie_outliers.png)

4. **Comparativo serie original vs procesada (winsorizing)**  
![Serie original vs procesada (winsorizing)](https://github.com/icherrez/prediccion-banano/blob/main/images/serie_winsorizing.png)

5. **Boxplot comparativo antes y después del tratamiento**  
![Boxplot comparativo original vs procesada](https://github.com/icherrez/prediccion-banano/blob/main/images/boxplot_comparativo.png)

6. **Descomposición STL (tendencia, estacionalidad y residuo)**  
![Descomposición STL](https://github.com/icherrez/prediccion-banano/blob/main/images/stl_descomposicion.png)
